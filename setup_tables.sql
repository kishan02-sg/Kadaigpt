-- KadaiGPT Database Schema
-- Run this in Supabase SQL Editor to create all tables

-- Create enum types
DO $$ BEGIN CREATE TYPE userrole AS ENUM ('owner', 'manager', 'cashier'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE billstatus AS ENUM ('draft', 'completed', 'cancelled', 'refunded'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE paymentmethod AS ENUM ('cash', 'upi', 'card', 'credit'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE syncstatus AS ENUM ('pending', 'synced', 'failed'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE ocrconfidence AS ENUM ('high', 'medium', 'low'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
CREATE TABLE IF NOT EXISTS handwritten_bills (
    id SERIAL PRIMARY KEY,
    store_id INTEGER NOT NULL REFERENCES stores(id),
